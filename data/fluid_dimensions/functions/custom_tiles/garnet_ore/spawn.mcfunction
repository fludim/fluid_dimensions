...
summon glow_item_frame ~ ~ ~ {Tags:["fd.garnet_ore","fd.ore"],Invulnerable:1b,Facing:1b,Invisible:1b,Fixed:1b,Item:{id:"minecraft:wooden_shovel",Count:1b,tag:{CustomModelData:4701008,display:{Name:'{"text":""}'}}}}
