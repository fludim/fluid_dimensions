...
execute positioned ~-0.5 ~ ~-0.5 run kill @e[type=minecraft:item,dx=1,dy=1,dz=1,nbt={Age:0s,Item:{id:"minecraft:iron_block"}},tag=!global.ignore,tag=!global.ignore.kill,limit=1]
