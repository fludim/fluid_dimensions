...
execute positioned ~ ~0.5 ~ run kill @e[distance=..0.7,type=minecraft:item,nbt={Age:0s,Item:{id:"minecraft:iron_block",Count:1b}},tag=!global.ignore,tag=!global.ignore.kill]
