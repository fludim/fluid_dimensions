...
execute unless entity @s[tag=fd.of.display_craft] run item replace block ~ ~ ~ container.15 with white_stained_glass_pane{CustomModelData:4470099,fd_of_fill:1,fd_of_gui_clear:1}
