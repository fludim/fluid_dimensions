...
execute align xyz positioned ~-0.5 ~ ~-0.5 run kill @e[type=item,tag=!smithed.entity,dx=1,dy=1,dz=1,nbt={Age:0s}]
# execute align xyz positioned ~-0.5 ~ ~-0.5 run kill @e[type=item,tag=!smithed.entity,dx=1,dy=1,dz=1,nbt={Age:0s,Item:{id:"minecraft:barrel"}},limit=1]
