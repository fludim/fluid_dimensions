...
execute as @s[advancements={fluid_dimensions:miasma=true}] unless entity @s[gamemode=creative,nbt={Inventory:[{id:"minecraft:clock",tag:{CustomModelData:4470025}}]}] run give @s minecraft:clock{fd:{id:"bottled_miasma"},display:{Name:'{"translate":"item.fd.bottled_miasma","italic":false}'},CustomModelData:4470025}
