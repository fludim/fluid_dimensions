...
execute at @s[scores={fd.hand_dist=0..25}] run tp @s ~ ~ ~ facing entity @e[limit=1,type=#fluid_dimensions:psirot_attack,tag=!smithed.entity,distance=..10,sort=nearest]
...
execute positioned ^ ^ ^0.5 positioned ~ ~1 ~ if entity @e[type=#fluid_dimensions:psirot_attack,tag=!smithed.entity,distance=0..1] run function fluid_dimensions:psirot/hand_dmg
