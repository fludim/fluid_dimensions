...
summon armor_stand ~ ~ ~ {CustomName:'{"translate":"entity.fd.psirot"}',CustomNameVisible:0b,NoGravity:1b,Small:1b,Invisible:1b,Tags:["fd.psirot_hand","global.ignore","global.ignore.modify"],DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:wooden_shovel",Count:1b,tag:{CustomModelData:4470053}}]}
