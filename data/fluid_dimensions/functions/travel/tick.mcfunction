...
execute if entity @s[predicate=fluid_dimensions:ypos/overworld_lb] run function fluid_dimensions:travel/go_end_from_overworld

# From End:
execute if entity @s[predicate=fluid_dimensions:ypos/the_end_ub] run function fluid_dimensions:travel/go_overworld_from_end
execute if entity @s[predicate=fluid_dimensions:ypos/the_end_lb] run function fluid_dimensions:travel/go_nether_from_end

# From Nether:
execute if entity @s[predicate=fluid_dimensions:ypos/the_nether_ub] run function fluid_dimensions:travel/go_end_from_nether
