...
execute as @e[sort=random,limit=16,tag=fd.cochineal] run function fluid_dimensions:underridge_mobs/cochineal
execute as @e[sort=random,limit=16,tag=fd.haunted] run function fluid_dimensions:underridge_mobs/haunted
execute as @e[sort=random,limit=16,tag=fd.psirot] run function fluid_dimensions:underridge_mobs/psirot
